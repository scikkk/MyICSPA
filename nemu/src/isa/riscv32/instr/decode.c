...
def_THelper(main) {
	...
	def_INSTR_IDTAB("??????? ????? ????? ??? ????? 00100 11", I     , integerimm); // main
	// wk 2.1

	// wk 2.2
	def_INSTR_IDTAB("??????? ????? ????? ??? ????? 01100 11", R     , integer); // main
	def_INSTR_IDTAB("??????? ????? ????? ??? ????? 11000 11", B     , branch); // main
	def_INSTR_IDTAB("??????? ????? ????? ??? ????? 00100 11", I     , shamt); // main
	def_INSTR_IDTAB("0000001 ????? ????? ??? ????? 01100 11", R     , muldiv); // main
